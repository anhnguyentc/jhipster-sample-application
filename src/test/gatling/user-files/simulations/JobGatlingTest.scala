...
class JobGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Job entity")
        ...
        .repeat(2) {
            ...
            .get("/services/jhipstersampleapplication/api/jobs")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new job")
            .post("/services/jhipstersampleapplication/api/jobs")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/jhipstersampleapplication${new_job_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created job")
            .delete("/services/jhipstersampleapplication${new_job_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
